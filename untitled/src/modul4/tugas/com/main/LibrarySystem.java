...
public class LibrarySystem {
    ...
    public static void main(String[] args) {
        daftarBuku[i++] = new StoryBook("SB32F", "OPM", 17, "Story", "Genos");
        daftarBuku[i++] = new HistoryBook("HB324", "HxH", 2, "History", "Gon");
        daftarBuku[i++] = new TextBook("TB323", "OP", 4, "Text", "Zoro");

        studentList.add(0, new Student("202310370311202", "Revaldo", "Teknik","Informatika"));
        studentList.add(1, new Student("202310370311203", "Reval", "Teknik","DKV"));
        studentList.add(2, new Student("202310370311204", "Valdo", "Teknik","System Information"));
